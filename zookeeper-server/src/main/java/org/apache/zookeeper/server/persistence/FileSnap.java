 ...
 * <p>
 * 记录zookeeper服务器在某一时刻的全量内存数据，并将其写入到指定位置磁盘上。存储内容包括DataTree信息和会话信息
 */
public class FileSnap implements SnapShot {
     ...
     * <p>
     *
     * 解析快照数据到datatree和sessions中，取出最新的100个快照数据，
     * 依次解析判断快照文件是否有数据且是可用的snapLog.deserialize(dt, sessions),返回快照文件数据的最大ZXID
     */
